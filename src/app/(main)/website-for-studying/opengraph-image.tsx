...
export const alt = 'Best Free Website for Studying | LofiSpace'
  ...
  return new ImageResponse(
    (
      <div style={{
        ...
        <span style={{ fontSize: 58, fontWeight: 800, color: '#fff', letterSpacing: '-2px', lineHeight: 1.1, display: 'flex', textAlign: 'center' }}>
          Best Website for Studying
        </span>
        <span style={{ fontSize: 26, color: '#a78bfa', fontWeight: 600, marginTop: 14, display: 'flex' }}>
          Lofi Music, Sounds & Pomodoro — All Free
        </span>
        <div style={{ fontSize: 19, color: 'rgba(255,255,255,0.45)', marginTop: 24, maxWidth: 660, textAlign: 'center', display: 'flex', lineHeight: 1.5 }}>
          Lofi music, ambient sounds, Pomodoro timer, and study scenes — free, no sign-up.
        </div>
        <div style={{ marginTop: 32, display: 'flex', alignItems: 'center', gap: 8, background: 'rgba(124,58,237,0.15)', border: '1px solid rgba(124,58,237,0.3)', borderRadius: 100, padding: '8px 20px' }}>
          <span style={{ color: '#a78bfa', fontSize: 17, display: 'flex' }}>focusworkspace.app/website-for-studying</span>
        </div>
      </div>
    ),
    size,
